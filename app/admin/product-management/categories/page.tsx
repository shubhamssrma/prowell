...
const CategoryPage = () => {
  ...
  const { categories, loading, error, pagination, categoryLoading } = useAppSelector(state => state.productReducer)
  ...
  useEffect(() => {
    dispatch(getCategories({ limit: itemsPerPage, page: currentPage, search: debouncedSearch }))
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              <h1 className="text-2xl font-bold mb-1">All Category</h1>
          ...
          <p className="text-sm text-gray-600 mb-4">
            Showing {startIndex + 1}-{Math.min(endIndex, pagination.total)} of {pagination.total} Categories
          </p>
            ...
            {showDeleteAlert && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 p-6">
                  <h3 className="text-lg font-semibold text-gray-800 mb-3">Delete Category</h3>
