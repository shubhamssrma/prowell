...
import { getCategories, getSpecies, getApplications, getRegions, getProductById } from '@/store/slices/productSlice';
...
const ProductForm: React.FC = () => {
  ...
  const { loading, error, categories, species, regions, applications, productDetails } = useAppSelector(state => state.productReducer)
  ...
  useEffect(() => {
    dispatch(getProductById({ id: productId as string }))
  }, [productId])
  ...
  useEffect(() => {
    if (productDetails) {
      ...
      const data = {
        ...
        categories: productDetails.categories.map(obj => obj._id),
        species: productDetails.species.map(obj => obj._id),
        applications: productDetails.applications.map(obj => obj._id),
        regions: productDetails.regions.map(obj => obj._id),
        ...
        quickFacts: {
          concentration: productDetails.quickFacts.concentration,
          activeIngredients: productDetails.quickFacts.activeIngredients,
          shelfLife: productDetails.quickFacts.shelfLife,
          packaging: productDetails.quickFacts.packaging,
          solubility: productDetails.quickFacts.solubility,
          withdrawalPeriod: productDetails.quickFacts.withdrawalPeriod,
        },
        // dosage: productDetails.dosage.filter(el => ({
        //   dosage:el.dosage,
        //   species:el.species._id
        // })),
        modeOfAction: productDetails.modeOfAction,
        keyBenefits: productDetails.keyBenefits,
        applicationUsage: productDetails.applicationUsage,
        ...
        // // 🔹 NEW
        productOverview: productDetails.productOverview,
        productDescription: productDetails.productDescription,
        productSmallDescription: productDetails.productSmallDescription,
        specSheet: productDetails.specSheet,
        sampleFile: productDetails.sampleFile,
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          ...
          <p className="text-gray-600">Fill in the details to edit product catalog</p>
        </div>
